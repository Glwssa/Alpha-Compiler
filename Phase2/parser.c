...
{
       0,   106,   106,   107,   110,   111,   115,   116,   117,   118,
     119,   120,   121,   122,   123,   124,   127,   128,   129,   130,
     131,   132,   133,   134,   135,   136,   137,   138,   139,   140,
     141,   144,   145,   146,   148,   158,   166,   174,   181,   184,
     203,   204,   205,   206,   207,   210,   213,   216,   219,   222,
     223,   224,   225,   228,   229,   230,   233,   234,   237,   239,
     241,   242,   245,   246,   249,   250,   252,   257,   258,   261,
     263,   263,   266,   266,   266,   266,   267,   267,   267,   267,
     270,   271,   272,   273,   274,   276,   276,   277,   280,   280,
     281,   283,   284,   286,   288,   291,   292
};
#endif
...
#line 139 "parser.y" /* yacc.c:1646  */
    {printf("(%d)(expr and expr)\n",++pnum);}
#line 1715 "parser.c" /* yacc.c:1646  */
    break;

  case 29:
#line 140 "parser.y" /* yacc.c:1646  */
    {printf("(%d)(expr or expr)\n",++pnum);}
...
#line 184 "parser.y" /* yacc.c:1646  */
    ...
    if(lock1==0&&lock2==0){
       if(IsFunction(scope,(yyvsp[-2].strVal),yylineno)==1) {
          printf("\033[0;31m");
...
#line 213 "parser.y" /* yacc.c:1646  */
    {	LookUpLocal((yyvsp[0].strVal),scope,yylineno);
        (yyval.strVal)=(yyvsp[0].strVal); lock1=1;
...
#line 216 "parser.y" /* yacc.c:1646  */
    {LookUpGlobal((yyvsp[0].strVal),yylineno);
        (yyval.strVal)=(yyvsp[0].strVal); lock2=1;
     printf("(%d)(lvalue->:: ID)\n",++pnum);}
